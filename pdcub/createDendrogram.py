...
def heatmap(output_file, data,row_labels, col_labels,cmap='',cbarlabel=''):
...
def main():
    ...
    heatmap(args.output_file,data,rowNames,colNames,cmap=args.colormap,cbarlabel = args.colorTitle)

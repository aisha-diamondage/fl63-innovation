...
```{r}
# directories
baseDir = here("rna-seq")
saveDir = here("rna-seq", "output")
...
The table below shows the detailed information for each sample (including ArgTCT_rep3, which is not used in this analysis.)
...
There seems to be a gene that's "siginificantly differenntiated" in many samples: NM_001313945 - Homo sapiens ras homolog family member A (RHOA), transcript variant 5, mRNA.

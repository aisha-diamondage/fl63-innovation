...
## load data
raw_counts <- read_csv("../data/counts/set1_NGS110_RNAseq_data.csv")
raw_counts <- raw_counts %>% column_to_rownames("target_id")

#gene_anno <- tibble(target_id = rownames(raw_counts), gene_name = raw_counts$gene_name)
...
### Principal theComponents Analysis without ArgTCT_rep3 {.tabset .pills}
...
I chose to use 7 PCs for the UMAP.
